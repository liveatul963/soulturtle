  ...
  return (
    <section className="relative py-20 px-6 bg-gradient-to-b from-[#FAFAF8] via-[#EAE6FB] to-[#DDEDE3] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {/* Main CTA with enhanced styling and subtle glow */}
        <div className="text-center">
          <TiltCard>
            <div className="bg-gradient-to-br from-[#EAE6FB] to-[#DDEDE3] rounded-3xl p-8 shadow-lg border border-white/50 max-w-2xl mx-auto h-[280px] flex flex-col justify-between animate-subtle-glow">
