      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 leading-relaxed mb-6 max-w-md font-normal">
        ...
        <div className="border-t border-gray-600 pt-6 mb-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-4 md:mb-0 font-normal">
        ...
        <div className="text-center pt-6 border-t border-gray-600">
          <p className="text-gray-400 text-lg italic mb-3 font-light">
